...
namespace SuiteCRMAddIn
{
    partial class frmSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.licenceGroup.Enabled = false;
			...
			// licenceText
			// 
			this.licenceText.Enabled = false;
			...
			this.licenceLabel.Enabled = false;
			...
			this.gbLDAPAuthentication.Enabled = false;
			...
			this.syncCalendarMenu.Location = new System.Drawing.Point(126, 45);
			...
			this.syncCalendarLabel.Location = new System.Drawing.Point(38, 48);
			...
			this.syncContactsMenu.Location = new System.Drawing.Point(126, 79);
			...
			this.syncContactsMenu.Visible = false;
			// 
			// syncContactsLabel
			// 
			this.syncContactsLabel.AutoSize = true;
			this.syncContactsLabel.Enabled = false;
			this.syncContactsLabel.Location = new System.Drawing.Point(38, 82);
			...
			this.syncContactsLabel.Visible = false;
			// 
			// syncLabel
			// 
